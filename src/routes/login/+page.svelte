...
<div class="screen">
	<Card>
		...
		<form method="post" action="?/signInEmail" use:enhance class="form">
			<TextField label="Correo electrónico" type="email" name="email" placeholder="correo@ejemplo.com" required />
		...
		<p class="footer-link">¿No tienes cuenta? <a href="/signup">Regístrate</a></p>
	</Card>
</div>
